...
import { AiFinancialCoachArticlePage } from "@/components/pages/AiFinancialCoachArticlePage";
...
export async function generateMetadata({
  ...
  return buildMetadata(locale, ARTICLES.aiFinancialCoach.path, {
    title: t("meta.title"),
...
export default function Page({ params }: { params: { locale: string } }) {
  ...
  return <AiFinancialCoachArticlePage locale={locale} />;
}
