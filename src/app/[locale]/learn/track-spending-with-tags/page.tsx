...
import { SpendingTagsArticlePage } from "@/components/pages/SpendingTagsArticlePage";
...
export async function generateMetadata({
  ...
  return buildMetadata(locale, ARTICLES.spendingTags.path, {
    title: t("meta.title"),
...
export default function Page({ params }: { params: { locale: string } }) {
  ...
  return <SpendingTagsArticlePage locale={locale} />;
}
